...
class FlourAndwaterCalculatorTests: XCTestCase {
    ...
    func testCalculation() throws {
        ...
        let levainQty = 160.0 // water + flour of levain
        
        let levainToFlourRatio = 25.0
        let breadHydratation = 75.0
        let flourToAdd = 640.0 // qty levain / (levain to flour ratio) ) = 160 / 0.25 = 640
        ...
        let totalFlour = flourToAdd + levainFlour
        ...
        let calculator = FlourAndWaterCalculator()
        ...
        XCTAssertEqual(flourToAdd, calculator.flourToAdd)
    ...
    func testCalculationTwo() {
        ...
        let calculator = FlourAndWaterCalculator()
        calculator.updateWith(levainHydratationPercent: levainHydratation * 100, levainQty: levain, levainToFlourRatioPercent: levainRatio * 100, breadHydratationPercent: breadHydratation * 100)
        
        XCTAssertEqual(levain, calculator.levain)
        ...
        XCTAssertEqual(flour, calculator.flourToAdd, accuracy: 0.0000001)
